...
export ACCOUNT=dollarbillgo
export CONTRACT=eosseieossei
...
cleos push action ${ACCOUNT} enroll '[ "'${ACCOUNT}'", "newrovp" ]' -p ${ACCOUNT}
cleos push action ${ACCOUNT} enroll '[ "'${ACCOUNT}'", "newrotaker" ]' -p ${ACCOUNT}
